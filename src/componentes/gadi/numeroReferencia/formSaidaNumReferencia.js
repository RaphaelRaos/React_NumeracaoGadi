...
export const FormSaidaNumRef = (props) => {
    ...
    const [datSaida_referencia, setSaida] = useState('');
    ...
    const saidaNumReferencia = async e => {
        ...
        await fetch(process.env.REACT_APP_SAIDA_REFERENCIA, {
            ...
            body: JSON.stringify({ id_referencia, datSaida_referencia, motivoDevolucao_referencia })
            ...
            <Container>
                ...
                <form onSubmit={saidaNumReferencia}>
                    <TableForm>
                        ...
                        <InputSaida type="date" name="datSaida_numReferencia" onChange={e => setSaida(e.target.value)} required >
                        </InputSaida>
                        <br />
                        <Label>MOTIVO DEVOLUÇÃO: </Label>
                        <InputSaida type="text" name="motivoDevolucao_referencia" onChange={e => setMotivoDevolucao(e.target.value)}>
                        </InputSaida>
                    </TableForm>
                    <DivButton>
                        <br></br>
